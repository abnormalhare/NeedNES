...
// LSR a,X
pub fn op_1E(self: *CPU) void {
    if (self.phi == 0) {
        op0.ai_rmw(self);
        return;
    }

    op1.absolute_indexed(self, .x, false);
