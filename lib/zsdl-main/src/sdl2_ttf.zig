...
pub const Font = opaque {
    ...
    pub fn renderTextBlendedWrapped(font: *Font, text: [:0]const u8, fg: sdl.Color, wrapLength: u32) !*sdl.Surface {
        return TTF_RenderText_Blended_Wrapped(font, text, fg, wrapLength) orelse sdl.makeError();
    }
    extern fn TTF_RenderText_Blended_Wrapped(font: *Font, text: [*c]const u8, fg: sdl.Color, wrapLength: u32) ?*sdl.Surface;
};
